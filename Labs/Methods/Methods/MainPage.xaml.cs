...
namespace Methods
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private (int, int) divide(int lefthandSide, int rightHandeSide)
        {
            expression.Text = $"{lefthandSide}/{rightHandeSide}";
            int division = lefthandSide / rightHandeSide;
            int remainder = lefthandSide % rightHandeSide;
